...
<!-- GENERATED by test/corpus/parity-report.ts from plain-parity-neato.json — do not edit by hand. -->

# neato plain/plain-ext parity dashboard

Differential survey of @knowvah/dot-engine `neato` plain/plain-ext output vs the
native `dot -K neato` oracle (`test/corpus/plain-walk.ts`), semantic
