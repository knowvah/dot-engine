...
|----|-------------|-------|--------|-----------|------|
| T6a | Faithful fix + unit test (commit 2) — if classification = misport | main (inline) | RCA-named files under src/layout/dot/, src/pathplan/, src/common/splines* + colocated test | T5 | [x] |
...
| T7 | End gates + closeout (commit 3) | main (inline) | test/corpus/parity.json, PARITY*.md, journal, memory | T6a or T6b | [x] |
